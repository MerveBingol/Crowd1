...
const forgetPassword =async(req,res)=>{
  ...
  const userInfo =await user.findOne({email}).select("FirstName lastName email")
if (!userInfo) return new APIError("Geçersiz kullnaıcı",400)
...
return new Response(true," Lütfen mail kutunuzu kontrol ediniz").succes(res)

}

    export {registerCompanyUser,registerPersonelUser,login,logout,forgetPassword}